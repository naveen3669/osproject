...
int main()
{
      ...
      int wait_time = 0, turnaround_time = 0,pos,z,p[10],prio[10], a_time[10];
	  int b_time[10], temp[10],b;
    ...
    for(b=0;b<limit;b++)
      ...
      printf("\nAverage turn around time:: %f",average_turnaround_time);
      average_wait_time = wait_time/limit;
      printf("\nAverage turn around time:: %f",average_wait_time);
      return 0;
}
